...
function Fileupload() {
  ...
  const removeFile = (name) => {
    const index = validFiles1.findIndex((e) => e.name === name);
    const index2 = selectedFiles.findIndex((e) => e.name === name);
    const index3 = unsupportedFiles.findIndex((e) => e.name === name);
    validFiles1.splice(index, 1);
  ...
  return (
    <>
      <div className="  w-full h-[267px]  flex flex-col justify-between">
        <h4 className="font-medium text-lg font-sfPro text-[#000000]"> Add Bill of Lading </h4>
